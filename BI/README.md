...
## Проекты по BI аналитике

### 1. Анализ выручки и прибыли - [проект](https://github.com/lenakosteva/portfolio/blob/main/BI/dashboard_revenue_profit_analysis.png)

Дашборд показывает комплексный анализ выручки и прибыли компании, сочетая агрегированные показатели и детализированные визуализации

### 2. Анализ деятельности магазина - [проект](https://github.com/lenakosteva/portfolio/blob/main/BI/dashboard_analysis_store.png)

Дашборд показывает анализ эффективности продаж в сети магазинов с товарами для животных

### 3. Воронка продаж - [проект](https://github.com/lenakosteva/portfolio/blob/main/BI/dashboard_sales_funnel.png)

Дашборд показывает анализ эффективности процесса конверсии от стадии бронирования до стадии завершения оплаты 
